...
$majorHobby = Get-Random $hobbiesList

do {
    $minorHobby = Get-Random $hobbiesList
} until ($minorHobby -notmatch $majorHobby)

return $majorHobby,$minorHobby